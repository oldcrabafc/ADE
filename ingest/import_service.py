...
from ingest.mapping_service import legacy_mapping_to_profile, validate_mapping
...
class ImportService:
    ...
    def import_to_client_db(self, request: ImportRequest) -> ImportResult:
        if request.profile is None:
            validate_mapping(request.field_mapping)
        ...
        profile = request.profile or legacy_mapping_to_profile(request.field_mapping)
